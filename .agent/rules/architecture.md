...
- **SEMPRE** use [Conventional Commits e gitmoji](https://www.conventionalcommits.org/ e https://gitmoji.dev/) para mensagens de commit. Exemplo: `:sparkles: feat: add start workout session endpoint`, `:bug: fix: workout plan validation`, `:memo: docs: update architecture rules`.
